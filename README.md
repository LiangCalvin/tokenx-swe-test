...
*   **End-to-End Simulation**: We will simulate the full user and admin lifecycle—from initial deposit and fund deployment to the final T+1 settlement.# tokenx-swe-test
